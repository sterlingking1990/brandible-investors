...
export default function Home() {
  ...
  // Check if user came from password reset callback
  useEffect(() => {
    const urlParams = new URLSearchParams(window.location.search);
    if (urlParams.get('password_setup') === 'true') {
  ...
  return (
    <main className="min-h-screen bg-gray-100">
      ...
      {(showPasswordSetup || hasPassword === false) && (
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="mt-1 text-sm text-blue-700">
                  Please set up your password to secure your investor account. Scroll down to the Account Settings section.
                </p>
              </div>
